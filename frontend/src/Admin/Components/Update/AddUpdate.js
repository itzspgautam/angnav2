...
import { PostCatDrawer } from "../Drawer/PostCatDrawer";
...
const AddPost = () => {
  ...
  const { postLoading, postCategories, error, success } = useSelector(
    (state) => state.Posts
  );
  ...
  const submitEventHandle = () => {
    ...
    Dispatch(createNewPost(poster, postData));
  };
            ...
            >
              ...
              <VStack alignItems={"start"} mt="2" w="100%">
                <Text
                  ...
                  w="100%"
                >
                  {des ? des : "Post Short Description"}
                </Text>
